...
class Book(Media):
    fields = ['call_number', 'title', 'subjects', 'author', 'description', 'publisher', 'city', 'year', 'series', 'notes']

    def __init__(self, line):
        '''zips and stores fields and line data together into dictionary'''
        self.__data = dict(zip(Book.fields, line))
        super(Book, self).__init__(self.__data['call_number'], self.__data['title'], self.__data['subjects'], self.__data['notes'])
